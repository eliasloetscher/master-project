...
class SubFrame2:
    def __init__(self, parent_frame):
        ...
        self.sub_frame2 = tk.Frame(parent_frame, width=600, height=600)
        self.sub_frame2.grid_propagate(False)
        self.sub_frame2.grid(row=3, padx=10, columnspan=4, sticky="W")
        self.sub_frame2.grid_forget()
        tk.Label(self.sub_frame2, text="Subframe 2", font="Helvetica 12 bold").grid(row=0, pady=20, columnspan=4,
                                                                                    sticky="W")